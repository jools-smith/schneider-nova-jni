...
//        		tra_get_string(tra, TRA_STRING_identity_field_name_ALIAS_3),
//				tra_get_string(tra, TRA_STRING_identity_ALIAS_7));
...
//        jvm.set_string_field(
//        		tra_get_string(tra, TRA_STRING_message_field_name_ALIAS_1),
//				tra_get_string(tra, TRA_STRING_ok_ALIAS_2));
